...
<html>
<head>
    <title>Insert to Learn_History</title>
...
<div class="sidebar">
  ...
  <a class="mainpage" href="./learn_history_page.php">Main Learn_History</a>
</div>

<div class="main">

<div class="header">
<h2>Insert a<i><u>new learning record</u></i>!</h2>
<p>Insert to this page will automatically insert to known_move table as well...</p>
</div>
...
function result_to_table($result, $qryres,$conn) {
        ...
        echo '<form action="insert_learn_history_page.php" method=POST>';
        ...
        echo '<input type="submit" value="Add to Learn_History" />';
        echo '</form>';
    }
